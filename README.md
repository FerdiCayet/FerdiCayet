### Olá, eu sou Fernando Caetano! :wave:
...
class FernandoCaetano extends FullstackDeveloper {
  ...
  toolsAndPractices = {
    ...
    methodologies: ['Desenvolvimento Ágil', 'Scrum', 'Kanban'],
    practices: ['Controle de Versão', 'Clean Code']
  };
}

export default new FernandoCaetano();
```
